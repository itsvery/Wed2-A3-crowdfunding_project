CREATE DATABASE  IF NOT EXISTS `crowdfunding_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `crowdfunding_db`;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='store the fundraiser categories.';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='store the list of available fundraisers.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-13 18:06:51
